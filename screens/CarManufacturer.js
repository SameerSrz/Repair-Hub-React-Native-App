...
export default function CarManufacturer() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
            <Animated.Text entering={FadeInUp.duration(1000).springify()} className="text-sky-400 pb-[30px] pt-[105px] font-bold tracking-wider text-5xl">
                Repair Buddies
            </Animated.Text>
      </View>
      <View>
      ...
      <ScrollView contentContainerStyle={styles.gridContainer}>
        ...
        <TouchableOpacity onPress={()=> navigation.push('Selection')}>
            <Animated.View entering={FadeInUp.duration(1000).springify()} style={styles.gridItem}>
                    <Text style={styles.text}>Hyundai</Text>
            </Animated.View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=> navigation.push('Selection')}>
            <Animated.View entering={FadeInUp.duration(1000).springify()} style={styles.gridItem}>
        ...
        <TouchableOpacity onPress={()=> navigation.push('Selection')}>
            <Animated.View entering={FadeInUp.duration(1000).springify()} style={styles.gridItem}>
                    <Text style={styles.text}>Changan</Text>
            </Animated.View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=> navigation.push('Selection')}>
            <Animated.View entering={FadeInUp.duration(1000).springify()} style={styles.gridItem}>
        ...
        <TouchableOpacity onPress={()=> navigation.push('Selection')}>
            <Animated.View entering={FadeInUp.duration(1000).springify()} style={styles.gridItem}>
                    <Text style={styles.text}>Rikshaw</Text>
            </Animated.View>
        </TouchableOpacity>
      </ScrollView>
    </View>
